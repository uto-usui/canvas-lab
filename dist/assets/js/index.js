 ...
 */
var mosaicImage = function mosaicImage(target) {
  var mosaicSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;
   ...
   * 画像情報からモザイクを描画する
   */
  var createMosaic = function createMosaic(context, width, height, size, data) {
   ...
   * カンバスに描画
   */
  var draw = function draw(_context, imageData, context) {
